...
<html>
  ...
  <body>
    ...
    <table width="100%" align="center">
      <tr>
        <td style="font-weight: bold"><a href="index.php">HOME</a></td>
        <td></td>
        <td></td>
        ...
        <td>
          <div class="dropdown">
            ...
            <div class="dropdown-content">
              <a href="modul/anggota/viewanggota.php">Anggota</a>
              <a href="modul/jenissimpanan/viewsimpanan.php">Jenis Pinjaman</a>
              <a href="modul/users/viewusers.php">User</a>
            </div>
          </div>
        </td>   
        <td>
          <div class="dropdown">
            ...
            <div class="dropdown-content">
              ...
              <a href="modul/simpanan/lookupsimpanan.php">Simpanan</a>
